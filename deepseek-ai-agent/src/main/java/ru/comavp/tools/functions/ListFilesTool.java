...
public class ListFilesTool implements Function<JsonValue, String> {

    public static Function<JsonValue, String> getListFilesTool() {
    ...
    public String apply(JsonValue input) {
        try {
            ...
            String path = ((JsonObject) input).values().containsKey("path")
                    ? ((JsonObject) input).values().get("path").asStringOrThrow()
                    : "";
